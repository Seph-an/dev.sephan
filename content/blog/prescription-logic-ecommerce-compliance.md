...
A pharmacy storefront must separate ordinary products from restricted purchase paths, minimise sensitive data collection and require authorised review wherever regulation or patient safety demands it.
...
Implementation claims in this article can be checked against [Kenya Data Protection Act](https://new.kenyalaw.org/akn/ke/act/2019/24/eng@2019-11-11), [Pharmacy and Poisons Board of Kenya](https://web.pharmacyboardkenya.org/).
