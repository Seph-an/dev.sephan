...
A reliable Kigali checkout should initiate MTN MoMo or Airtel Money server-side, verify the provider callback before marking an order paid, and retain a review path for delayed or ambiguous transactions.
...
Implementation claims in this article can be checked against [MTN MoMo developer portal](https://momodeveloper.mtn.com/), [Airtel Africa developer portal](https://developers.airtel.africa/), [Rwanda Data Protection and Privacy Law](https://dpo.gov.rw/dpp-law/general-provisions).
